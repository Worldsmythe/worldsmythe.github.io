...
```javascript title="library.js" src="script-configuration-with-story-cards/library/start.js"
```

### Input Tab
```javascript title="input.js" src="script-configuration-with-story-cards/input.js"
```
...
```javascript title="library.js" before="script-configuration-with-story-cards/library/start.js" after="script-configuration-with-story-cards/library/data-structure.js"
```
...
```javascript title="library.js" before="script-configuration-with-story-cards/library/data-structure.js" after="script-configuration-with-story-cards/library/use-data.js"
```
...
```javascript title="library.js" before="script-configuration-with-story-cards/library/use-data.js" after="script-configuration-with-story-cards/library/parse-config.js"
```
...
```javascript title="library.js" before="script-configuration-with-story-cards/library/parse-config.js" after="script-configuration-with-story-cards/library/simple-values.js"
```
...
```javascript title="library.js" before="script-configuration-with-story-cards/library/simple-values.js" after="script-configuration-with-story-cards/library/dictionaries.js" collapse={2-30,134-140}
```
...
```javascript title="library.js" before="script-configuration-with-story-cards/library/dictionaries.js" after="script-configuration-with-story-cards/library/final.js"
```
...
```javascript title="library.js" src="script-configuration-with-story-cards/library/final.js"
```
